...
import {femaleNames, gasCarModels, lastNames, maleNames} from "../Constants.tsx";
                    ...
                    gameState.lifeEventManager!.replaceEvent(new LifeEvent("Combining finances", gameState.date,
                        <div className="flex flex-col w-full items-center">
                            ...
                            <ButtonNext style="w-50 text-xl h-10 p-1 font-bold mt-2"
                                ...
                                gameState.character.cars = [...gameState.character.cars, new Car(32000, new Date(gameState.date.getFullYear(), random.int(0, 11), random.int(1, 28)), 20, 25, false, 180, "src/resources/Car icon.svg", gasCarModels[random.int(0, gasCarModels.length - 1)], 1)]
