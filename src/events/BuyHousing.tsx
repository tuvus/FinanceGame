    ...
    return (<div className="flex flex-col gap-4 items-center">
                ...
                <p className="text-xl text-gray-700! pl-1">$
                    <NumberInputAutoSelect
                        ...
                        onChange={e => {
                            ...
                            setCash(Math.min(Math.max(e.target.valueAsNumber, 0), Math.ceil(100 * Math.min(gameState.character.savingsAccount.balance, cost)) / 100));
                        }}>
                    </NumberInputAutoSelect>
                </p>
            </div>
        ...
        <ButtonNext
            ...
            action={() => {
                ...
                gameState.character.payMoney(Math.min(cash, cost));
                if (loan > 0.001)
