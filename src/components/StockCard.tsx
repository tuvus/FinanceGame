...
import "../App.css";
import {Account, type Stock} from "../Data.tsx";
    ...
    return (<>
        <div className="flex flex-col items-center bg-amber-100 rounded-xl p-4 m-4 gap-1">
            ...
            <p className="text-gray-700">
                Shares: {Math.round(stock.a.shares * 100) / 100} ({formatter.format(stock.a.getValue())})
            </p>
            <div className="flex gap-2">
                ...
                {stock.a.shares > 0 ? <button className="w-40 text-xl h-10 font-bold" onClick={() => {
                    setStocksToBuySell(Math.floor(stock.a.shares * 100) / 100);
                        ...
                        <div className="flex gap-2 justify-center">
                            ...
                            <button
                                onClick={() => {
                                    ...
                                    stock.a.shares += stocksToBuySell;
                    ...
                    <div
                        ...
                        <div className="flex">
                            ...
                            <input name="sell-shares" className="w-80 bg-white rounded-xl p-1 text-gray-700"
                                   ...
                                   max={stock.a.shares}
                                   value={stocksToBuySell}
                                   onChange={(e) => setStocksToBuySell(Math.min(stock.a.shares, e.target.valueAsNumber))}
                                   type="number">
                            </input>
                        </div>
